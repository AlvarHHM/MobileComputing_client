...
/**
 * Generated Account request.
 *
 * @since 1.3.0
 */
public class AccountRequest extends JsonHttpRequest {

  /**
   * Builds an instance of AccountRequest.
   *
  ...
  /** Returns response with indentations and line breaks. */
  public AccountRequest setPrettyPrint(Boolean prettyPrint) {
  ...
  /** Selector specifying which fields to include in a partial response. */
  public AccountRequest setFields(String fields) {
    this.fields = fields;
    return this;
  }
 ...
 * assigned to a user, but should not exceed 40 characters. Overrides userIp if both are provided.
 */
  public AccountRequest setQuotaUser(String quotaUser) {
  ...
  /** OAuth 2.0 token for the current user. */
  public AccountRequest setOauthToken(String oauthToken) {
 ...
 * reports. Required unless you provide an OAuth 2.0 token.
 */
  public AccountRequest setKey(String key) {
    this.key = key;
    return this;
  }
 ...
 * limits.
 */
  public AccountRequest setUserIp(String userIp) {
    this.userIp = userIp;
    return this;
  }
  ...
  /** Data format for the response. */
  public AccountRequest setAlt(String alt) {
    this.alt = alt;
    return this;
  }
}
